...
if ($upload1_is_ok === 1 && $upload2_is_ok === 1) {
    ...
    exec(
        "sudo su - sepadmin -c '/home/sepadmin/Documents/afl/scripts/startTheJobs.sh $P1san $P2san $P3san $P4san $P5san $P6san $P7san $filename1 $filename2' , $tmpout, $svr_exec_is_ok"
    );
    echo '<hr>
